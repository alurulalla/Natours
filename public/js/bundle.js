      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://localhost:4000/api/v1/users/logout');

          case 3:
            res = _context2.sent;
            (0, _alert.showAlert)('success', 'Successfully Loggedout');
          ...
          case 9:
            ...
            (0, _alert.showAlert)('error', 'Unable to logout.');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWx1cnVtdXJhbGlrcmlzaG5hOSIsImEiOiJja2lvZ3I0ZXYxYXIwMnFsYmszNHB6aDczIn0.SWa3_GpXGzdK3fuQpZ8UEQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/alurumuralikrishna9/ckiogzmvj0bhl17nq8i778oqg',
    scrollZoom: false //   center: [-118.553222, 34.208899],
    //   zoom: 10,
    //   interactive: false,
...
var stripe = Stripe('pk_test_51GxnbhFNOpexbCUvbKXFUXiL2khYZAArmEqRvRZCRInvnp37HLT7uHjSah9P1ojCq8gvybFYj39CMd9iUsB11vvZ00JrI3fZlq');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:4000/api/v1/booking/checkout-session/".concat(tourId));
...
var userAccount = document.querySelector('.nav__user-img');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); // VALUES

var email = document.getElementById('email');
var password = document.getElementById('password'); // DELEGATION
